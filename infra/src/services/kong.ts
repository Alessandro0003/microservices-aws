...
import { invoicesHttpListeners } from './invoices';
import { ordersHttpListeners } from './orders';
    ...
    container: {
      ...
      environment: [
        ...
        { 
          ...
          value: pulumi.interpolate`http://${ordersHttpListeners.endpoint.hostname}:${ordersHttpListeners.endpoint.port}`,
        },
        {
          name: 'INVOICES_SERVICE_URL',
          value: pulumi.interpolate`http://${invoicesHttpListeners.endpoint.hostname}:${invoicesHttpListeners.endpoint.port}`
        }
      ],
    },
  },
